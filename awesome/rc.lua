...
local editor            = os.getenv("EDITOR") or "gnvim"
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "F4", function () awful.util.spawn( "vlc --video-on-top" ) end,
    ...
    -- super + shift + ...
    awful.key({ modkey, "Shift" }, "Escape", function () awful.util.spawn( "xkill" ) end,
        {description = "Kill proces", group = "hotkeys"}),

		--screen locker
    awful.key({ modkey, "Shift"  }, "l", function() awful.util.spawn( "xlock  systemctl suspend" ) end,
        {description = scrlocker, group = "alt+ctrl"}),
    awful.key({ modkey, modkey1   }, "l", function() awful.util.spawn( "/usr/local/bin/lock" ) end,
        {description = scrlocker, group = "alt+ctrl"}),

    -- screenshots
    awful.key({ }, "Print", function () awful.util.spawn("scrot -s 'screenshot_%Y%m%d-%H%M%S_$wx$h.png' -e 'mv $f $$(xdg-user-dir PICTURES) ; xviewer $$(xdg-user-dir PICTURES)/$f'") end,
        {description = "Scrot", group = "screenshots"}),
    awful.key({ modkey           }, "Print", function () awful.util.spawn( "scrot -d 5 'screenshot_%Y%m%d-%H%M%S_$wx$h.png' -e 'mv $f $$(xdg-user-dir PICTURES) ; xviewer $$(xdg-user-dir PICTURES)/$f'" ) end,
